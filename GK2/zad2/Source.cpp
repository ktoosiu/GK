...
void RenderScene(void)
{
	...
	//	angle = (GLfloat)i / 15 * 3.1415926 * 2.0;
	//for (angle = 0.0f; angle < (2.43f*GL_PI); angle += (GL_PI / 7.0f))
	//	{
	//		// Wyliczenie wspó³rzêdnych x i y kolejnego wierzcho³ka
	//		x = 50.0f*sin(angle);
	//		y = 50.0f*cos(angle);
