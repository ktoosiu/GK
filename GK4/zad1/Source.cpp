...
void GenerateTextures()
{
	...
	GLboolean error = load_targa("blonde.tga", width, height, format, type, pixels);

	// b³¹d odczytu pliku
	if (error == GL_FALSE)
	{
		printf("Niepoprawny odczyt pliku blonde.tga");
		exit(0);
	}
	...
	//// wczytanie tekstury poooooop.tga
	//GLboolean error = load_targa("poooooop.tga", width, height, format, type, pixels);

	//// b³¹d odczytu pliku
	//if (error == GL_FALSE)
	//{
	//	printf("Niepoprawny odczyt pliku poooooop.tga");
	//	exit(0);
	//}

	//// utworzenie identyfikatora tekstury
	//glGenTextures(1, &POOP);

	//// dowi¹zanie stanu tekstury
	//glBindTexture(GL_TEXTURE_2D, POOP);
	...
	//// dowi¹zanie stanu tekstury
	//glBindTexture(GL_TEXTURE_2D, POOP_UNC);
	...
	error = load_targa("blonde_gray.tga", width, height, format, type, pixels);

	// b³¹d odczytu pliku
	if (error == GL_FALSE)
	{
		printf("Niepoprawny odczyt pliku blonde_gray.tga");
		exit(0);
	}
...
int main(int argc, char *argv[])
{
	...
	glutCreateWindow("Kompresja tekstur Blonde");
